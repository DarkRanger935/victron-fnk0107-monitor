...
**Note:** This creates a persistent user-site import path entry for the system-Python flow documented in this README.
If you later move/delete the repo, remove it with:
```bash
